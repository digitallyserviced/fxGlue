...
exports.gluePreprocessShader = void 0;
const imports = {
    math: `
...
const getShaderHeader = (append) => `#version 300 es
#ifdef GL_ES
 ...
 */
function gluePreprocessShader(source, vertex = false, customImports = {}) {
    ...
    for (const line of lines) {
        ...
        if (trimmed.startsWith('@use ')) {
            ...
            if ((customImports[trimmed] || imports[trimmed]) &&
...
exports.gluePreprocessShader = gluePreprocessShader;
