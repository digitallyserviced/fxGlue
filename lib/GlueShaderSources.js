...
exports.blendFragmentShader = exports.defaultVertexShader = exports.defaultFragmentShader = exports.GlueBlendMode = void 0;
/**
 * Blend mode. Do not use the string values directly.
 */
var GlueBlendMode;
(function (GlueBlendMode) {
    GlueBlendMode[GlueBlendMode["NORMAL"] = 0] = "NORMAL";
    GlueBlendMode[GlueBlendMode["DISSOLVE"] = 1] = "DISSOLVE";
    GlueBlendMode[GlueBlendMode["DARKEN"] = 2] = "DARKEN";
    GlueBlendMode[GlueBlendMode["MULTIPLY"] = 3] = "MULTIPLY";
    GlueBlendMode[GlueBlendMode["COLOR_BURN"] = 4] = "COLOR_BURN";
    GlueBlendMode[GlueBlendMode["LINEAR_BURN"] = 5] = "LINEAR_BURN";
    GlueBlendMode[GlueBlendMode["LIGHTEN"] = 6] = "LIGHTEN";
    GlueBlendMode[GlueBlendMode["SCREEN"] = 7] = "SCREEN";
    GlueBlendMode[GlueBlendMode["COLOR_DODGE"] = 8] = "COLOR_DODGE";
    GlueBlendMode[GlueBlendMode["LINEAR_DODGE"] = 9] = "LINEAR_DODGE";
    GlueBlendMode[GlueBlendMode["OVERLAY"] = 10] = "OVERLAY";
    GlueBlendMode[GlueBlendMode["SOFT_LIGHT"] = 11] = "SOFT_LIGHT";
    GlueBlendMode[GlueBlendMode["HARD_LIGHT"] = 12] = "HARD_LIGHT";
    GlueBlendMode[GlueBlendMode["VIVID_LIGHT"] = 13] = "VIVID_LIGHT";
    GlueBlendMode[GlueBlendMode["LINEAR_LIGHT"] = 14] = "LINEAR_LIGHT";
    GlueBlendMode[GlueBlendMode["PIN_LIGHT"] = 15] = "PIN_LIGHT";
    GlueBlendMode[GlueBlendMode["HARD_MIX"] = 16] = "HARD_MIX";
    GlueBlendMode[GlueBlendMode["DIFFERENCE"] = 17] = "DIFFERENCE";
    GlueBlendMode[GlueBlendMode["EXCLUSION"] = 18] = "EXCLUSION";
    GlueBlendMode[GlueBlendMode["SUBTRACT"] = 19] = "SUBTRACT";
    GlueBlendMode[GlueBlendMode["DIVIDE"] = 20] = "DIVIDE";
    GlueBlendMode[GlueBlendMode["HUE"] = 21] = "HUE";
    GlueBlendMode[GlueBlendMode["SATURATION"] = 22] = "SATURATION";
    GlueBlendMode[GlueBlendMode["COLOR"] = 23] = "COLOR";
    GlueBlendMode[GlueBlendMode["LUMINOSITY"] = 24] = "LUMINOSITY";
    GlueBlendMode[GlueBlendMode["LIGHTER_COLOR"] = 25] = "LIGHTER_COLOR";
    GlueBlendMode[GlueBlendMode["DARKER_COLOR"] = 26] = "DARKER_COLOR";
})(GlueBlendMode = exports.GlueBlendMode || (exports.GlueBlendMode = {}));
...
exports.blendFragmentShader = `@use wrap
@use color
@use noise
@use mask
